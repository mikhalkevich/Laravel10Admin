...
>
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
            <li class="relative px-6 py-3 {{($end == 'catalog')?'bg-gray-50':''}}">
                <a
                ...
                >
                    ...
                    <span class="ml-4">@lang('my.catalog')</span>
                </a>
            </li>

            <li class="relative px-6 py-3 {{($end == 'product')?'bg-gray-50':''}}">
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="{{asset('admin/product')}}"
                >
                    <svg
                        class="w-5 h-5"
                        aria-hidden="true"
                    ...
                    <span class="ml-4">@lang('my.product')</span>
                </a>
            </li>
            <li class="relative px-6 py-3 {{($end == 'charts')?'bg-gray-50':''}}">
                ...
                >
                    ...
                    <span class="ml-4">@lang('my.chart')</span>
                </a>
            </li>
            <li class="relative px-6 py-3 {{($end == 'users')?'bg-gray-50':''}}">
                ...
                >
                    ...
                    <span class="ml-4">@lang('my.user')</span>
                </a>
            </li>
        </ul>
    </div>
